...
const Navbar = () => (
  <nav className="fixed w-full bg-black text-white px-6 py-4 flex items-center justify-between shadow border-b border-gray-800 rounded-b-lg z-index">
    {/* Left: Logo */}
    <div className="flex items-center space-x-6">
      <Link to="/" className="text-xl font-bold text-accentPrimary">NxtUp</Link>
    </div>
